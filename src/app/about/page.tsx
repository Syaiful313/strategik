              ...
              <div className="p-0 md:col-span-2">
                <FadeInSection delay={300}>
                  <h1 className="mb-4 text-2xl font-medium leading-tight md:text-4xl">
                    ...
                    powerhouse of creativity, innovation, and passion for
              ...
              <div className="text-md mt-3 grid w-full grid-cols-1 gap-6 md:w-[60%] md:text-2xl">
                <FadeInSection>
                  <p>
                    ...
                    importance of standing out. Our mission is simple yet
                    powerful – to elevate your brand experience. Whether it's
                    through compelling social media campaigns, seamless
                    e-commerce solutions, or visually striking websites, we're
                    here to make your brand shine.
                  </p>
                  <p>
                    Whether you're a startup with a vision or an established
                    brand seeking a fresh digital perspective, we invite you to
                    join us on this exciting journey. Let's not just meet
                    expectations but exceed them, together.
                  </p>
                  <p className="text-lg font-bold md:text-2xl">
                    Welcome to Strategik – where your brand's success is not
                    just a goal; it's a commitment.
                  </p>
                </FadeInSection>
              </div>
