      ...
      <div className="min-h-screen bg-[#1A1A1A] px-24 text-white">
        <div className="container mx-auto px-4 py-12">
          ...
          <p className="mx-16 max-w-6xl text-xl md:text-2xl">
            Boost your brand's online presence with Strategik's Social Media
            mastery – from strategy to engaging content, we drive growth across
            platforms.
          </p>
        </div>
        ...
        <h2 className="mx-16 mb-12 max-w-6xl pt-10 text-4xl font-bold md:text-6xl">
          WHAT'S INCLUDED?
        </h2>
