...
const EcommercePage = () => {
  return (
    <>
      <div className="min-h-screen bg-[#1A1A1A] px-24 text-white">
        <div className="container mx-auto px-4 py-12">
          ...
          <p className="mx-16 max-w-6xl text-xl md:text-2xl">
            Optimize your online store with Strategik's E-commerce solutions.
            Elevate user experience and implement strategic marketing for a
            thriving digital storefront.
          </p>
        </div>
        ...
        <h2 className="pt-10 mx-16 max-w-6xl mb-12 text-4xl font-bold md:text-6xl">
          WHAT'S INCLUDED?
        </h2>
        <div className="mx-16 max-w-4xl space-y-12 text-start">
          <div className="pt-8">
          ...
          <div className="pt-8">
            ...
            <p className="text-lg text-gray-300">
              ...
              brand story authentically. From eye-catching visuals to compelling
              copy, we ensure your social media presence reflects the essence of
              your brand.
            </p>
          </div>
          ...
          <div className="pt-8">
            ...
            <p className="text-lg text-gray-300">
              We don't just stop at posting – we constantly monitor and analyze
              social media metrics to fine-tune our approach. Through
        ...
        <div className="container mx-16 max-w-5xl py-10">
          ...
          <div className="max-w-4xl">
            <p className="mb-5 text-lg leading-relaxed text-gray-300">
              ...
              success in the dynamic landscape of social media. With Strategik,
              it's more than a service – it's a strategic and iterative
              partnership committed to elevating your brand's social media
              presence.
            </p>
            ...
            <div className="max-w-4xl">
              <p className="text-lg leading-relaxed text-gray-300">
                ...
                focused on elevating your brand's social media presence through
                a well-defined and iterative process.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* <div className="max-w-6xl bg-[#1A1A1A] px-24 text-white">
